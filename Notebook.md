...
https://docs.google.com/presentation/d/185zenMU8fr2Q38utx3xBmxfYM3sukzy46l0OCE5oRJY/edit?usp=sharing
| Term | Definition | Base Structure / Syntax | Real Life Example | App Example |
|------|------------|--------------------------|-------------------|-------------|
...
|dot noatation | Methods are called on objects using a dot after the object name |object.method(value); | | |
|Concatenate |To combine Strings with other Strings and/or varibles |String greeting = "Hello" + "My name is " + name ". "; | | |
...
<img width="1198" height="398" alt="image" src="https://github.com/user-attachments/assets/54c2e818-e4e8-481b-8031-a58dba0db7e1" />
